...
def custom_score_2(game, player):
    ...
    """
    # TODO: finish this function!
    # using difference in open moves for scoring (player 1 open moves, vs player 2 open moves)
...
def custom_score_3(game, player):
    ...
    """
    # TODO: finish this function!
    #implementing open moves - double of opponent open moves score
    if game.is_loser(player):
        return float("-inf")
